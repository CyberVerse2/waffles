...
// into src/app/data/questions.ts (the hand-authored wc-001..025 are left
// untouched). Idempotent: re-running strips any existing wc-026+ rows first,
// so it can be edited and re-run freely.
//
...
const file = path.resolve(import.meta.dirname, "../src/app/data/questions.ts");
